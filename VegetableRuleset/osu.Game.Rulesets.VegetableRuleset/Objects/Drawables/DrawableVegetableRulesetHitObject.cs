...
namespace osu.Game.Rulesets.VegetableRuleset.Objects.Drawables
{
    public class DrawableVegetableRulesetHitObject : DrawableHitObject<VegetableRulesetHitObject>
    {
        private BindableNumber<int> currentLane;

        public DrawableVegetableRulesetHitObject(VegetableRulesetHitObject hitObject)
            : base(hitObject)
        {
            Size = new Vector2(40);

            Origin = Anchor.Centre;
            Y = hitObject.Lane * VegetableRulesetPlayfield.LANE_HEIGHT;
        }

        [BackgroundDependencyLoader]
        private void load(VegetableRulesetPlayfield playfield, TextureStore textures)
        {
