...
{
    [Cached]
    public class VegetableRulesetPlayfield : ScrollingPlayfield
    {
        public const float LANE_HEIGHT = 70;

        public const int LANE_COUNT = 6;

        public BindableInt CurrentLane => vegetableruleset.LanePosition;

        private VegetableRulesetCharacter vegetableruleset;
            ...
            AddRangeInternal(new Drawable[]
            {
                new LaneContainer
                {
                    ...
                    Child = new Container
                    {
                        ...
                        {
                            HitObjectContainer,
                            vegetableruleset = new VegetableRulesetCharacter
                            {
