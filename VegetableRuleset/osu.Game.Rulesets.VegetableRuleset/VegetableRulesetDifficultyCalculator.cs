...
{
    public class VegetableRulesetDifficultyCalculator : DifficultyCalculator
    {
        public VegetableRulesetDifficultyCalculator(Ruleset ruleset, WorkingBeatmap beatmap)
